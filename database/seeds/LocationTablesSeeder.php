...
class LocationTablesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $Ivano = App\LocationRegion::create(["alias"=>"Ivano-Frankivsk","name"=>"Ивано-Франковская","translit"=>"Ivano-Frankovskaya","type"=>"region","available"=>"yes"]);
        $Ivano->administrativeCenter()->create(["alias"=>"Ivano-Frankivsk","name"=>"Ивано-Франковск","translit"=>"Ivano-Frankovsk"]);
